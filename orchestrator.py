...
class PortfolioOrchestrator:
    ...
    def process_monthly_aporte(
        ...
        # Step 5: Apply risk management constraints (simplified)
        final_allocation = meso_allocation
...
Confidence: {regime.get('confidence', regime.get('strength', 0)):.1%}
...
=== DECISION RATIONALE ===
Given the {regime['regime'].upper()} market regime,
the {decision.profile_name} profile adjusts risk exposure accordingly.
...
"""
    ...
    def get_portfolio_summary(self) -> Dict:
        """Get current portfolio summary (mock implementation)"""
        return {
    ...
    def get_current_regime(self) -> Dict:
        ...
        if self.decision_log:
            ...
            return last.regime or {"regime": "unknown", "confidence": 0.0}
        return {"regime": "intermediate", "confidence": 0.75}


# Alias for backward compatibility with backend_api.py
